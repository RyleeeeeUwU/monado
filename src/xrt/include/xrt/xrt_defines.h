...
enum xrt_input_name
{
	...
	XRT_INPUT_WMR_A_CLICK                        = XRT_INPUT_NAME(0x009A, BOOLEAN),
	XRT_INPUT_WMR_B_CLICK                        = XRT_INPUT_NAME(0x009B, BOOLEAN),
	XRT_INPUT_WMR_X_CLICK                        = XRT_INPUT_NAME(0x009C, BOOLEAN),
	XRT_INPUT_WMR_Y_CLICK                        = XRT_INPUT_NAME(0x009D, BOOLEAN),
	XRT_INPUT_WMR_CLIFFHOUSE_CLICK               = XRT_INPUT_NAME(0x009E, BOOLEAN),

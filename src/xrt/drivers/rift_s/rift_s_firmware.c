...
static bool
json_read_vec3(const nx_json *nxj, const char *key, vec3f *out)
{
...
static bool
json_read_mat4x4(const nx_json *nxj, const char *key, mat4x4f *out)
{
	const nx_json *member = nx_json_get(nxj, key);
...
static bool
json_read_mat3x3(const nx_json *nxj, const char *key, float out[3][3])
{
	const nx_json *member = nx_json_get(nxj, key);
	int i = 0;
...
static bool
json_read_led_point(const nx_json *led_model, rift_s_led *led, int n)
{
	const nx_json *array;
...
static bool
json_read_lensing_model(const nx_json *lensing_model, rift_s_lensing_model *model, int n)
{
	const nx_json *array;
	char name[32];
	int j;
